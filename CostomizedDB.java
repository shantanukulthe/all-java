//Project OF Customized Database
import java.util.*;
class Node
{
	public int rno;
...
class CostomizedDB
{
	public static void main(String arg[])
	{
		...
		System.out.println("Costomized DB Started");
		
		while(true)
		{
			System.out.println("CostomizedDB:>");
			...
			if(tokens.length ==1)
			{
				...
				{
					System.out.println("Thank you for using CostomizedDB");
					break;
				}
			}
